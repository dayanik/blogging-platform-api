...
RESTful API приложение -- бекенд блога без пользователей. Это реализация одной из множества идей портала [roadmap.sh](https://roadmap.sh/projects/blogging-platform-api).
